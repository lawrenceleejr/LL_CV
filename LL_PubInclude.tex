...
%% $\RHD$ marks a primary editor, primary analyzer, or intellectual lead role.
  ...
  \item  \href{https://inspirehep.net/authors/1071846}{Over \inspirestat{papers} published papers, mostly as part of the ATLAS and CMS Collaborations, with over \inspirestat{citations} citations, and an $h$-index of \inspirestat{hindex} [\textit{INSPIRE}].} Valid authorship in the ATLAS and CMS Collaborations requires a record of and continued contributions to the operation, maintenance, and improvements of the experiments in service of all of the collaboration's activities. Selected publications with significant direct contributions are listed below, with \inspirecollectioncitations{} citations, an $h$-index of \inspirecollectionhindex{}, and a $g$-index of \inspirecollectiongindex{} [\inspirecollectionlink{\textit{INSPIRE}}]. \textit{{$\RHD$} indicates a primary editor, primary analyzer, or intellectual lead role.}

  \par\smallskip
  \begingroup
    \renewcommand{\inspireplotwidth}{0.64\linewidth}%
    \renewcommand{\inspireplotheight}{3.12cm}%
    % A running total rather than the per-year series; see LL_Preamble.tex.
    % Per year, this label should read citations/yr instead.
    %
    % Tick labels are set in math mode, where a comma is punctuation and takes a
    % thin space after it -- the first four-digit tick read "1, 000".  \! cancels
    % exactly that space.  Bracing the comma does not work: pgf strips the braces
    % when it stores the key.
    \renewcommand{\inspireplotstyle}{cumulative, ylabel={cumul. citations},
      y tick label style={/pgf/number format/assume math mode}}%
    \centering\inspirecollectionplot\par
  \endgroup
  ...
  \begin{enumerate}
    ...
    \item $\RHD$ L.~Jeanty, L.~Lee, \inspirepub{3103093}{Rare and Experimentally Challenging Supersymmetry Signatures}, \emph{Ann. Rev. Nucl. Part. Sci.} 76 (2026) 423--458, \emph{Invited} \whenflush{2026}

    \item M.~Bauer, O.~Brandt, L.~Lee, C.~Ohm, \inspirepub{1756729}{ANUBIS: AN Underground Belayed In-Shaft search experiment}, \href{https://arxiv.org/abs/1909.13022}{\emph{arXiv}, 1909.13022}, \emph{Accepted by APS Open Science}\whenflush{2026}
...
Intra-Beam Stripping}, \emph{JACoW NAPAC2025} THP014 \newline \emph{(Proceedings, norm for publication in Accelerator Physics)} \whenflush{2025}
    ...
    \item $\RHD$ L.~Lee, C.~Bell, J.~Lawless, C.~Nash, E.~Nibigira, \inspirepub{2690093}{Experimental Impact of Jet Fragmentation Reference Frames At Particle Colliders}, \emph{Phys. Lett. B} 866, 139561  \whenflush{2025}
  ...
  \\ \emph{arXiv}, 2502.00181, \emph{Submitted to PRD}  \whenflush{2025}
  ...
  \item $\RHD$ A.~Badea, W.~Fawcett, J.~Huth, T.J.~Khoo, R.~Poggi, L.~Lee, \inspirepub{2005570}{Solving Combinatorial Problems at Particle Colliders Using Machine Learning}, \emph{Phys. Rev. D} 106 1, 016001 \whenflush{2022}
  ...
  \item CMS Collaboration, \inspirepub{2962374}{A general search for supersymmetric particles in scenarios with compressed mass spectra using proton-proton collisions at $\sqrt{s}$ = 13 TeV}, \emph{Phys. Rev. D} 112 (2025) 11, 112023 \whenflush{2025}
 ...
 \item $\RHD$ ATLAS Collaboration, \inspirepub{1856547}{A search for the decays of stopped long-lived particles at $\sqrt{s}=13$~TeV with the ATLAS detector}, \emph{JHEP} 173 \whenflush{2021}
  ...
  \item ATLAS Collaboration, \inspirepub{1498566}{Search for new phenomena in events containing a same-flavour opposite-sign dilepton pair, jets, and large missing transverse momentum in $\sqrt{s} = 13$~TeV pp collisions with the ATLAS detector}, \emph{Eur. Phys. J. C} 77, 144\whenflush{2017}
  ...
  \item $\RHD$ ATLAS Collaboration, \inspirepub{1458270}{Search for squarks and gluinos in final states with jets and missing transverse momentum at $\sqrt{s} = 13$~TeV with the ATLAS detector}, \emph{Eur. Phys. J. C} 76, 392\whenflush{2016}
  ...
  \item $\RHD$ ATLAS Collaboration,
    ...
    \emph{Phys. Rev. D} 91, 112016\whenflush{2015}
  ...
  \item $\RHD$ ATLAS Collaboration, \inspirepub{1298030}{Light-quark and Gluon Jet Discrimination in pp Collisions at $\sqrt{s} = 7$~TeV with the ATLAS Detector},
    \emph{Eur. Phys. J. C} 74, 3023\whenflush{2014}
  ...
  \item ATLAS Collaboration, \pub{https://cds.cern.ch/record/2037905}{First look at pp collisions data at $\sqrt{s} = 13$~TeV in preparation for a search for squarks and gluinos in final states with jets and missing transverse momentum with the ATLAS detector},~ATL-PHYS-PUB-2015-028\whenflush{2015}
