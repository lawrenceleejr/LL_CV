...
%% $\RHD$ marks a primary editor, primary analyzer, or intellectual lead role.
  ...
  \begingroup
    ...
    % \mathord keeps the thousands comma an ordinary symbol: tick
    % labels are set in math mode, where a bare comma is punctuation and picks
    % up a thin space after it -- "1, 000".  Only cumulative values reach four
    % digits, so the per-year series never showed this.
    \renewcommand{\inspireplotstyle}{cumulative, ylabel={cumulative citations},
      y tick label style={/pgf/number format/1000 sep={\mathord{,}}}}%
