...
\emph{Multi-Year Grants}
  ...
  \begin{itemizetighter}
    ...
    \item CMS Phase-II Upgrade Project Support - \$110k \when{2022--}
...
\section*{Professional Activities}
  ...
  \begin{itemizetighter}
    \item \href{https://github.com/lawrenceleejr/inspirehep-latex}{\emph{inspirehep-latex} package developer} \when{2026}
    \item RCSA Reviewer \when{2026} % For Cottrell
    \item Lead organizer, \textmu{}CATALYST summer accelerator program \when{2026}
...
\section*{Selected Scientific Presentations}
  ...
  \begin{itemizetighter}
    ...
    \item Fermilab -- \emph{Physics Forum, Agentic AI Workflows} \when{2026} % September 17, 2026

    \item UC San Diego -- \emph{Physics Colloquium, Cottrell Lecture} \when{2026} % May 7, 2026

    \item San Diego State University -- \emph{Physics Colloquium, Cottrell Lecture} \when{2026} % May 8, 2026

    \item Cornell University -- \emph{HEP Seminar} \when{2026} % April 24, 2026

    \item Fermilab -- \emph{Wine \& Cheese Seminar} \when{2026} % 16 Jan 2026

    \item Yale University -- \emph{NPA Seminar} \when{2024} % 9 May 2024

    \item New York University -- \emph{Physics Colloquium} \when{2024} % March 2024

    \item University of California, Irvine, Virtual -- \emph{AI Seminar} \when{2022}
    % July 12, 2022
...
\end{itemizetighter}
  ...
  \item AI4MuC -- \emph{Invited Overview Talk} \when{2026} % June 29, 2026
...
\section*{Teaching}
  ...
  \internalonly{
    ...
    \begin{itemizetighter}
      ...
      % Held back until after graduation, then uncomment here and carry the award
      % into the Past Student \textit{\&} Postdoc Mentorship entry below:
      % \item \rightnote{DOE Office of Science Graduate Student Research (SCGSR) Award}
      ...
      % Held back until after graduation, then uncomment here and carry the award
      % into the Past Student \textit{\&} Postdoc Mentorship entry below:
      % \item \rightnote{CMS Breakthrough Prize Fellowship}
  ...
  \textit{n.b. Square brackets denote initial position of mentorship relationship. Current position in italics.}
    ...
    \begin{itemizetighter}
      ...
      \item Everett Hagen [Undergrad, UTK] \hfill \emph{Physics PhD Student, University of Hawaii}
...
\section*{Selected Outreach Activities}
  ...
  \begin{itemize}
    ...
    \item \href{https://docentoutreach.org}{\textbf{DOCENT}} - \emph{Open-Source Outreach Tracking Software} \when{2026--}

      \begin{itemizetighter}
      \item \emph{Distributed Outreach \textit{\&} Community Engagement Network Tracker}: a self-hosted web application that lets a scientific community keep one shared record of its outreach, see its geographic coverage, and export grant-ready Broader Impacts documentation.
      \item Author and maintainer. FastAPI, PostgreSQL, and React, released under the GPL.
      \end{itemizetighter}
...
\section*{University, College, and Departmental Committees and Other Service Roles}
  ...
  \begin{itemizetighter}
    ...
    \item Peer Teaching Evaluation Committee \when{2026--}

    \item UTK Academy for Global Engagement - Mentor \when{2026--27}

    \item Undergraduate Mentoring Committee \when{2025--}
    ...
    \item Graduate Recruitment Committee  \when{2023--25}
    ...
    \item Qualifying Exam Committee \when{2022--23, 24--26}
