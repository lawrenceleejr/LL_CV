...
%% The column is measured, not guessed: at 11pt EB Garamond with oldstyle
%% figures the widest date in regular use is "2008--2009" at 47.9pt, and 4.5em
%% is 49.3pt.  Re-measure whenever the text face or the figure style changes --
%% digit widths differ between both, and a column a shade too narrow silently
%% sends its widest dates flush right, which tools/check_alignment.py accepts as
%% legitimate.  Oldstyle figures are the narrower of the two styles here.
\newlength{\datecolumn}
\setlength{\datecolumn}{4.5em}
